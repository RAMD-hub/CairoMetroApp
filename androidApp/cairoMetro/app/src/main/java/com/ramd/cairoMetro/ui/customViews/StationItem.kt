...
class StationItem( val station:String ,
    ...
    override fun bind(viewBinding: StationProgressBinding, position: Int) {
        ...
        if(start) {
            viewBinding.spStationName.text = context.getString(R.string.start_in, station, line)
            ...
            viewBinding.spStationName.text = context.getString(R.string.end_in, station, line)
            ...
            viewBinding.spStationName.text = context.getString(R.string.change_to, station, line)
        }
    }
